...
<table>
    ...
    <tr><td>Your Email:</td><td><?= $form->input('text', ['name' => 'email']) ?></td></tr>
    ...
    <tr><td colspan="2" align="center"><?= $form->input('reset', ['value' => 'Reset']) ?><?= $form->input('submit', ['value' => 'Order']) ?>
    </td></tr>
